...
public class Aesthetics {
	...
	public static final Color BUTTON_BACKGROUND = new Color(0x2961BA);
	public static final Color BUTTON_BORDER = new Color(0x3971CA);
	public static final int BUTTON_BORDER_SIZE = 5;
